  ...
  useEffect(() => {
    ...
    const fetchLiveResults = async () => {
      try {
        ...
        console.log('CGL Data:', cglData);
        console.log('CHSL Data:', chslData);
        console.log('NTPC Data:', ntpcData);
    
        // Set state with valid data or empty arrays
        setLiveResults({
        ...
        // Handle failure for all categories
        setLiveResults({
          cgl: [],
          chsl: [],
          ntpc: [],
...
//   const [tests, setTests] = useState([]);
//   const [accessStatus, setAccessStatus] = useState({});
//   const [selectedExam, setSelectedExam] = useState('CHSL');
//   const [liveResults, setLiveResults] = useState({
//     cgl: [],
//     chsl: [],
//     ntpc: [],
