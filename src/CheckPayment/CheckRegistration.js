...
const PaymentComponent = () => {
  ...
  const getPrice = () => {
    switch (plan) {
      case '30 Days': return 79;
      case '25 Days': return 69;
      case '3 Days': return 39;
      case '90 Days': return 199;
      case '180 Days': return 349;
      case '365 Days': return 599;
      default: return 0;
    }
  };
          ...
          {isRegistered === true && (
            <div className="plan-selection">
              ...
              <select value={plan} onChange={handlePlanChange} className="plan-select">
                <option value="30 Days">30 Days - ₹79</option>
                <option value="25 Days">25 Days - ₹69</option>
                <option value="3 Days">3 Days - ₹39</option>
                <option value="90 Days">90 Days - ₹199</option>
                <option value="180 Days">180 Days - ₹349</option>
                <option value="365 Days">365 Days - ₹599</option>
              </select>
              <BuyTyping
