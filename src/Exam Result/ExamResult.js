...
//         // Create dropdown structure: { "SSC": [{ examName: "CGL", paper_code: "..." }, ...], ... }
...
//     } else {
//       setExamResults([]); // Clear results if no paper_code found
//     }
//   };
...
//       setExamResults([]); // Clear results if there's an error
//     } finally {
//       setLoading(false);
//     }
//   };
...
//           ) : selectedPaperCode && examResults.length === 0 ? (
